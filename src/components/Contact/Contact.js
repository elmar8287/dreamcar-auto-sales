  ...
  const contactMethods = [
    {
      ...
      contact: "dreamcarautosales@hotmail.com",
    },
    {
      icon: (
        <svg
    ...
    },
    {
      ...
      contact: "672 7th ave Kirkland WA 98033",
    },
  ];
      ...
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
        <div className="max-w-lg mx-auto gap-12 justify-between lg:flex lg:max-w-none">
          ...
          <div className="flex-1 mt-12 sm:max-w-lg lg:max-w-md">
            <form
              action="https://formspree.io/f/mbjwjnay"
              method="POST"
              onSubmit={submitedHandle}
              className="space-y-5"
            >
              <div>
            ...
            {submited ? (
              <div className="sent-message">Message successfully sent</div>
            ) : null}
          </div>
        </div>
      </div>
