        ...
        <div className="card">
          ...
          <div className="car-container">
            ...
            <ul>
              ...
              <button type='button' className="sold"><a href="https://seattle.craigslist.org/see/ctd/d/kirkland-2014-mercedes-sprinter-2500/7463823261.html" target="_blank" rel="noreferrer">Sold</a></button>
          </div>
        </div>
      </div>
    </div>
